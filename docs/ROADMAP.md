...
> **v2.4.0（2026-07-11）＝ M9 學習深度**：
> ① 動詞變化訓練 — 41 個 N5 動詞（五段/一段/不規則）ます/て/ない/た形 4 選 1
> drill，干擾項＝同動詞他形＋他動詞同形；② AI 情境對話 — Claude 扮演店員/地勤
...
> **v2.6.2（2026-07-14）＝ 詞彙量成長加速**（使用者回饋：單字量太少、舊字輪迴）：
